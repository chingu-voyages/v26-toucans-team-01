...
homeownerInsuranceInput.addEventListener('input',function() {
  ...
  calculateMonthlyPayment(principleInterestInput.value, additionalCosts);
  chartResults(principleInterestInput.value, updatedHomeInsurance, propertyTaxInput.value, hoaFeeInput.value);
});
propertyTaxInput.addEventListener('input',function() {
  ...
  calculateMonthlyPayment(principleInterestInput.value, additionalCosts);
  chartResults(principleInterestInput.value, homeownerInsuranceInput.value, updatedPropertyTax, hoaFeeInput.value);
});
hoaFeeInput.addEventListener('input',function() {
  ...
  calculateMonthlyPayment(principleInterestInput.value, additionalCosts);
  chartResults(principleInterestInput.value, homeownerInsuranceInput.value, propertyTaxInput.value, updatedHoaFee);
});
